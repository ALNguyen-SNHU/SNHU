...
This file contains the implementation of the 12 hour clock class functions.
This file is mostly a copy of the 24 hour clock class cpp file with some changes.
