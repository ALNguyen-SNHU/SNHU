// Controls the REST API for GameUser management
// Handles requests like getting, creating, updating, and deleting game users.
// Like if: "Can I see all game users?" or "Can I create a new game user?" - this controller answers those questions by managing the GameUser data.
...
// Setting the path/route to access game users.
@Path("/gameusers")
...
public class GameUserRESTController {
    ...
    // Only allow the user role to access this method.
    @RolesAllowed("USER")
    ...
    // Only allow the admin role to access this method.
    @RolesAllowed("ADMIN")
