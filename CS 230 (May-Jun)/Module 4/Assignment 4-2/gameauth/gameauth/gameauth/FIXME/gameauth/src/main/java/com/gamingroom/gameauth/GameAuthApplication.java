...
// Boots up the GameAuth application, registers resources, health checks, and security features.
...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// Exposes the GameUser REST API endpoints for managing game users. (Via: GameUserRESTController.java)
		// Without this, the app won't respond when someone tries to access the gameusers page.
		...
		// Helper tool to create a Jersey client for making REST calls. Like an app asking another part of the app (itself) for data.
